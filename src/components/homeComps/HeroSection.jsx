  ...
  return (
    <div className="mx-4 mt-10 grid grid-cols-1 gap-6 md:mx-8 md:mt-16 lg:mx-20 lg:mt-20 lg:grid-cols-2">
      <div className="maintext flex flex-col">
        ...
        <button className="group inline-flex w-full max-w-xs flex-col items-start justify-center rounded-2xl bg-amber-500 px-5 py-3.5 shadow-[0px_1px_1px_0px_rgba(0,0,0,0.12)] shadow-[0px_2px_5px_0px_rgba(103,110,118,0.08)]">
          <Link href={"/login"}>
